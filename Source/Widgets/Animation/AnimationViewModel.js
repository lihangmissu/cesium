...
define([
    ...
    AnimationViewModel.defaultDateFormatter = function(date, viewModel) {
        ...
        return gregorianDate.year+"-"+monthNames[gregorianDate.month - 1]+"-"+ gregorianDate.day;
    };
    ...
    AnimationViewModel.defaultTimeFormatter = function(date, viewModel) {
        ...
        return sprintf("%02d:%02d:%02d", gregorianDate.hour, gregorianDate.minute, gregorianDate.second);
    };
