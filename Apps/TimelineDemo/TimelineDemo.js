...
define([
    ...
    function updateScrubTime(julianDate) {
        document.getElementById('mousePos').innerHTML = timeline.makeLabel(julianDate);
    }
    ...
    function handleSetZoom(e) {
        dojo.byId('formatted').innerHTML =
            //'<br/>Epoch: ' + timeline.makeLabel(e.epochJulian) + ' ' +
...
/*
    ...
    function newDatesSelected() {
        ...
        var startJulian=JulianDate.fromIso8601("2017-02-15T00:00:00Z");
        var endJulian=JulianDate.fromIso8601("2017-02-15T12:00:00Z");
